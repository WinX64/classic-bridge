...
class SpawnPlayerClientboundPacket(input: ByteBuf, settings: ExtensionSettings) : ClassicInboundPacket {
    ...
    override fun notifyCallback(callback: ClassicPacketCallback) = callback.onSpawnPlayer(this)
